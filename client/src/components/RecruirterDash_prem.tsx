...
const RecruirterDash_prem = (props: Props) => {
  ...
  return (
    <div className='p-3 md:mx-auto'>
      <h1 className='text-center font-bold text-white text-xl bg-orange-600 rounded-md mb-2'>Premium Dashboard for the Recruiters</h1>
...
export default RecruirterDash_prem;
